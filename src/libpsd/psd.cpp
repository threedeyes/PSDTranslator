...
static psd_status psd_image_load_tag(psd_context ** dst_context, BPositionIO * stream, psd_load_tag load_tag)
{
	psd_context * context;
	psd_status status;
...
psd_status psd_image_load(psd_context ** dst_context, BPositionIO * stream)
{
	return psd_image_load_tag(dst_context, stream, psd_load_tag_all);
}

psd_status psd_image_load_header(psd_context ** dst_context, BPositionIO * stream)
{
	return psd_image_load_tag(dst_context, stream, psd_load_tag_header);
}

psd_status psd_image_load_layer(psd_context ** dst_context, BPositionIO * stream)
{
	return psd_image_load_tag(dst_context, stream, psd_load_tag_layer);
}

psd_status psd_image_load_merged(psd_context ** dst_context, BPositionIO * stream)
{
	return psd_image_load_tag(dst_context, stream, psd_load_tag_merged);
}

psd_status psd_image_load_thumbnail(psd_context ** dst_context, BPositionIO * stream)
{
	return psd_image_load_tag(dst_context, stream, psd_load_tag_thumbnail);
}

psd_status psd_image_load_exif(psd_context ** dst_context, BPositionIO * stream)
{
#ifdef PSD_INCLUDE_LIBXML
	return psd_image_load_tag(dst_context, stream, psd_load_tag_exif);
#else
